...
const wordCards = [
  { number: "01", title: "みことばの力",  text: "神のみことばは私たちを生かします。朝、昼、夜に食事を摂るように、人間は神の言葉を食べて（読んで、聞いて、消化し、実践して）生きるように造られています。" },
  { number: "02", title: "聖霊様の助け", text: "イエス様を信じる人の内側には聖霊様がおられます。聖霊様は神の言葉を教え、悟らせ、行わせてくださる助け主です。" },
  { number: "03", title: "祈りながら聞く",text: "「聖霊様、神のみことばを教え、悟らせ、行わせてください」と祈りつつ、神の言葉を聞いていきましょう。" },
  { number: "04", title: "信仰と祝福",   text: "神の言葉を聞くときに信仰が生まれ、神を喜ばせることができます。神の言葉を実践できるように祈りつつ、行動に移すなら、神の祝福が人生に溢れていきます。" },
];
