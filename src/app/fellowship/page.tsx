            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="w-full md:w-7/12 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2.5">
                  {[
                    { icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z", label: "毎月土曜日", note: (
                      <>
                        （開催日は毎月
                        <a
                    ...
                    <div key={item.label} className="flex items-center gap-3">
                      ...
                      <span className="text-navy text-sm font-medium">
                        {item.label}
                        {item.note && (
                          <span className="text-gray-500 text-xs font-normal ml-1.5">{item.note}</span>
                        )}
                      </span>
                    </div>
                  ))}
