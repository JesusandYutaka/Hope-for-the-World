        ...
        <div className="flex flex-col md:flex-row items-start gap-6 md:gap-12 mb-16">
          ...
          <div className="w-full md:w-3/5 space-y-5 pt-2">
            ...
            <div className="space-y-5 text-gray-600 leading-[1.9] text-sm">
              ...
              <p>
                伝道師でも、幼稚園教諭でもなくなった私は、ふと思いました。「自分は、いったい何者なのか？」祈りの中で、神様がこう言ってくださいました。「あなたはわたしの愛する息子だ。」その言葉が、私のすべてを変えました。肩書きでも、実績でも、役職でもない。神様の息子であることが、私の本当のアイデンティティーだと知ったのです。私は神様に尋ねました。「私の職場は、どこですか？」すると、こう語りかけてくださいました。「あなたの就職先は、神の国だよ。」それ以来、私のアイデンティティーは揺るがなくなりました。どんな時も、神様に愛されている神の息子――それが私です。
              </p>
              <p>
                妻と0歳の息子と共に、毎日をイエス様と歩んでいます。
              </p>
              <p>
                最後に、このサイトを訪れてくださったあなたへ。あなたを心から愛し、あなたのために命を捨てたお方がいます。それが、イエス様です。私はイエス様を信じて20年が経ちました。それでも今も、このお方と歩む人生の素晴らしさに感動し続けています。あなたにも、この喜びを体験していただきたい。ぜひこのサイトをゆっくり楽しんでください。気になることがあれば、何でも「つながる」フォームからお気軽にご連絡ください。
              </p>
