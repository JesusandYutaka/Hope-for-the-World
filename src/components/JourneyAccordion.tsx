        ...
        return (
          <div
            ...
            className={`bg-white rounded-2xl border shadow-sm transition-all duration-300 overflow-hidden ${
              isOpen ? "border-[#C9A84C]/40 shadow-md" : "border-[#e8f0fe] hover:border-[#C9A84C]/20 hover:shadow"
            }`}
          >
            <button
            ...
            >
              <div className="flex items-center gap-4">
                <span className={`text-[10px] font-medium tracking-[0.35em] uppercase transition-colors ${isOpen ? "text-[#C9A84C]" : "text-[#C9A84C]/60"}`}>
                  {item.eyebrow}
                </span>
                <span className="w-px h-4 bg-[#e8f0fe]" />
                <span className="text-[#1a2e5a] font-serif font-bold text-lg leading-snug">
                  {item.title}
                </span>
              </div>
              <span
                className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center border transition-all duration-300 ml-4 ${
                  isOpen
                    ...
                    : "border-[#e8f0fe] group-hover:border-[#C9A84C]/40"
                }`}
              >
                <svg
